-- 초기 적재용 (CTAS) — 이후 일별 적재는 raw_conv_web_imp.sql 사용
-- 실행 전 date_range CTE의 start_yyyymmdd / end_yyyymmdd 수동 설정

CREATE TABLE "prod_addi_conv"."raw_conv_web_imp"
WITH (
    external_location = 's3://ptbwa-da/prod/prod_addi_conv/raw_conv_web_imp/',
    format = 'PARQUET',
