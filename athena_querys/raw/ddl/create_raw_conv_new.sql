-- 초기 적재용 (CTAS) — 이후 일별 적재는 raw_conv_new.sql, 구간 적재는 raw_conv_new_range.sql 사용
...
CREATE TABLE "prod_addi_conv"."raw_conv_new"
WITH (
    external_location = 's3://ptbwa-da/prod/prod_addi_conv/raw_conv_new/',
    format = 'PARQUET',
